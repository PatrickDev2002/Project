  ...
  return (
    <section className={utilStyles.abdtTutoStyle}>
      ...
      <h2 className={utilStyles.twoFirstSkillsFont}>
        <p>(G) + (K) + (O), alternate with (^)</p>
        <p>(F) + (N) + (+) + (6), alternate with (9)</p>
      </h2>
      <div className={utilStyles.twoFirstSkills}>
        <video
          className={utilStyles.videoStyles}
          controls
          width="500"
          height="300"
        >
      ...
      <h3 className={utilStyles.twoLastSkillsFont}>
        <p>(R) + (G) + (^) + (+), alternate with the (7)</p>
        <p>(Y) + (N) + (+), alternate with the (I)</p>
      </h3>
      ...
      <a href="/posts/first-postMac">← Back to the tuto</a>
    </section>
  );
}
